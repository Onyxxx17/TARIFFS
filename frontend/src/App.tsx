...
export default function App() {
  return (
    <Layout>
        ...
        <div className="mx-auto max-w-9xl h-[65vh] md:h-[90vh] grid grid-cols-12 items-center gap-6 px-6">
          ...
          <div className="col-span-12 md:col-span-6 z-10 ml-4">
            ...
            <p className="mt-3 max-w-md text-slate-600">
              Accurate tariff calculations for global trade—clear, fast, and
              reliable.
            </p>
      ...
      <section
        id="section 2" className="min-h-screen bg-gradient-to-b from-[#2d6ebb] to-white flex items-center">
        <div style={{ margin: "100px" }}>
          <p className="mx-auto text-3xl text-blue-800/85 mt-4 font-semibold body-paragraph">
            Enter two countries to calculate tariffs and get back results in
            real time!
          </p>
          <div style={{ marginTop: "70px" }}>
            <div style={{ display: "inline-block", marginRight: "220px" }}>
              <p className="mx-auto text-2xl text-blue-800/85 mt-4 font-semibold body-paragraph">
                Import from:
              </p>
            </div>
