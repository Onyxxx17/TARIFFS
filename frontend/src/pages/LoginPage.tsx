        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="px-6 sm:px-10 pb-8 sm:pb-10">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <a href="#" className="text-sm text-[#2d6ebb] hover:text-[#2563eb] font-medium transition-colors">
                    Forgot?
                  </a>
                </div>
                <input
            ...
            <p className="text-center mt-6 text-sm sm:text-base text-gray-600">
              ...
              <Link to="/signup" className="text-[#2d6ebb] font-semibold hover:text-[#2563eb] transition-colors">
                Sign up
              </Link>
            </p>
          </div>
