      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 border-b-4 border-blue-600">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="text-center">
            <span className="inline-block px-4 py-1.5 mb-4 text-xs font-semibold tracking-wider text-blue-400 uppercase bg-blue-900/30 rounded-full border border-blue-400/30">
              News & Analysis
            </span>
          ...
          {posts.slice(1).map((p) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <Link to={`/blog/${p.slug}`}>
                  <h3 className="text-lg font-bold text-slate-900 mb-2 leading-tight hover:text-blue-600 transition-colors line-clamp-2">
                    {p.title}
                  </h3>
                </Link>
