...
function TrumpTariffArticle() {
  return (
    <article className="prose prose-lg max-w-none">
      ...
      <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-5">
        Typically, the charge is a percentage of a good's value.
      </p>

      <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-600 dark:border-blue-500 p-6 my-8 rounded-r-lg">
      ...
      <div className="bg-slate-100 dark:bg-slate-700/50 p-6 rounded-lg my-8">
      ...
      <div className="bg-amber-50 dark:bg-amber-900/30 border-l-4 border-amber-500 dark:border-amber-600 p-6 my-8 rounded-r-lg">
  ...
  return (
    <article className="prose prose-lg max-w-none">
      ...
      <div className="space-y-3 my-8">
        <div className="bg-white dark:bg-slate-700/50 border-l-4 border-slate-300 dark:border-slate-600 p-5 rounded">
          <h3 className="font-semibold text-base text-slate-900 dark:text-white mb-2">Brazil</h3>
        ...
        <div className="bg-white dark:bg-slate-700/50 border-l-4 border-slate-300 dark:border-slate-600 p-5 rounded">
          <h3 className="font-semibold text-base text-slate-900 dark:text-white mb-2">European Union</h3>
          <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-700/50 border-l-4 border-slate-300 dark:border-slate-600 p-5 rounded">
          <h3 className="font-semibold text-base text-slate-900 dark:text-white mb-2">United Kingdom</h3>
          <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-700/50 border-l-4 border-slate-300 dark:border-slate-600 p-5 rounded">
          <h3 className="font-semibold text-base text-slate-900 dark:text-white mb-2">China</h3>
          <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-700/50 border-l-4 border-slate-300 dark:border-slate-600 p-5 rounded">
          <h3 className="font-semibold text-base text-slate-900 dark:text-white mb-2">Canada</h3>
          <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-700/50 border-l-4 border-slate-300 dark:border-slate-600 p-5 rounded">
          <h3 className="font-semibold text-base text-slate-900 dark:text-white mb-2">Mexico</h3>
          <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
      ...
      <div className="bg-slate-100 dark:bg-slate-700/50 border-l-4 border-slate-400 dark:border-slate-500 p-6 my-8 rounded">
      ...
      <div className="bg-slate-50 dark:bg-slate-700/30 border border-slate-200 dark:border-slate-600 p-6 rounded-lg my-8">
      ...
      <div className="mt-8 p-6 bg-white dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600 rounded-lg">
        <h4 className="font-semibold text-base text-slate-900 dark:text-white mb-4">
          Impact on landed cost calculation:
        </h4>
        <ol className="list-decimal ml-6 space-y-2 text-slate-700 dark:text-slate-300 text-sm">
    ...
    <article className="prose prose-lg max-w-none">
      <div className="not-prose mb-8">
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
          ...
          <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">The US-China trade war and phase one agreement</a>,{" "}
          <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Trump's Trade War Timeline: An Up-to-Date Guide</a>, and{" "}
          <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline">Trump's trade war timeline 2.0: An up-to-date guide</a>.
        </p>
      ...
      <div className="not-prose mb-8">
        <h2 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white leading-tight mb-6">
          US-China trade war tariffs: An up-to-date chart
        </h2>
        <div className="inline-block bg-blue-600 dark:bg-blue-700 text-white px-4 py-2 rounded text-sm font-semibold mb-6">
      ...
      <div className="bg-slate-50 dark:bg-slate-700/50 border-l-4 border-slate-400 dark:border-slate-500 p-6 my-8 rounded">
      ...
      <div className="bg-white dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600 p-6 rounded-lg my-8">
        <p className="text-base text-slate-700 dark:text-slate-300 leading-relaxed">
      ...
      <div className="bg-slate-100 dark:bg-slate-700/50 border-l-4 border-blue-600 dark:border-blue-500 p-6 my-8 rounded">
      ...
      <div className="not-prose mt-12 pt-8 border-t border-slate-200 dark:border-slate-700">
        ...
        <div className="space-y-3">
          <div className="flex gap-4">
            <div className="font-semibold text-blue-700 dark:text-blue-400 text-sm w-32 flex-shrink-0">January 1, 2018</div>
            <div className="text-sm text-slate-700 dark:text-slate-300">US Section 201 tariffs imposed on solar panels and washing machines</div>
          </div>
          <div className="flex gap-4">
            <div className="font-semibold text-blue-700 dark:text-blue-400 text-sm w-32 flex-shrink-0">March 12, 2018</div>
            <div className="text-sm text-slate-700 dark:text-slate-300">US Section 232 tariffs imposed on steel, aluminum, and derivative products</div>
          </div>
          <div className="flex gap-4">
            <div className="font-semibold text-blue-700 dark:text-blue-400 text-sm w-32 flex-shrink-0">April 5, 2025</div>
            <div className="text-sm text-slate-700 dark:text-slate-300">US tariffs of 10 percent imposed on nearly all countries, including China, under IEEPA</div>
          </div>
          <div className="flex gap-4">
            <div className="font-semibold text-blue-700 dark:text-blue-400 text-sm w-32 flex-shrink-0">August 7, 2025</div>
            <div className="text-sm text-slate-700 dark:text-slate-300">US tariffs adjusted on nearly all countries with a trade surplus with the US, under IEEPA</div>
          </div>
          <div className="flex gap-4">
            <div className="font-semibold text-blue-700 dark:text-blue-400 text-sm w-32 flex-shrink-0">September 25, 2025</div>
            <div className="text-sm text-slate-700 dark:text-slate-300">US tariffs adjusted on imports from EU after clarification of US-EU deal</div>
          </div>
        </div>
      </div>
    </article>
...
function EUTariffRussiaBelarusArticle() {
  return (
    <article className="prose prose-lg max-w-none">
      <div className="not-prose mb-8">
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">23 July 2025</p>
      </div>
      ...
      <p className="text-base text-slate-700 dark:text-slate-300 leading-relaxed mb-5">
        ...
        <span className="text-blue-600 dark:text-blue-400 font-medium">Annex I to Regulation (EU) 2025/1227</span> (around those not affected) 
      ...
      <div className="bg-white dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600 rounded-lg p-6 my-8">
      ...
      <div className="bg-slate-50 dark:bg-slate-700/50 border-l-4 border-slate-400 dark:border-slate-500 p-6 my-8 rounded">
        ...
        <ul className="space-y-2 text-slate-700 dark:text-slate-300 text-sm ml-4">
    ...
    <div className="bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors">
      ...
      <div className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 transition-colors">
        <div className="mx-auto max-w-4xl px-6 py-8">
          <Link 
            to="/blog" 
            className="inline-flex items-center gap-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 mb-6 transition-colors"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
          ...
          <div className="mb-4">
            <span className="inline-block px-3 py-1 text-xs font-semibold text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 rounded-full">
              Trade Policy
            </span>
          </div>
      ...
      {/* Share Section */}
      <div className="bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700 transition-colors">
        <div className="mx-auto max-w-4xl px-6 py-8">
