    ...
    <div className="relative" ref={dropdownRef}>
      ...
      <div className="relative">
        <input
          ...
          className="w-full rounded-lg border border-slate-300 px-3 py-2 pr-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-200"
          disabled={loading}
        />
      ...
      {/* Loading state */}
      {loading && (
        <p className="mt-1 text-xs text-slate-500">Loading countries...</p>
      )}
    </div>
  );
}
